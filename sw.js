const CACHE='iw-cache-8.76-single-color-shields-v1';
const ASSETS=[
  './',
  './index.html',
  './style.css?v=8.76.0',
  ...
  './assets/effects/player-shield-level1-v2.png',
  './assets/effects/player-shield-level2-v2.png',
  './assets/effects/player-shield-level3-v2.png',
