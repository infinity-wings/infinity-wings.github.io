...
class BattleEventSystem{
 ...
 decorateSpawnedEnemy(enemy){if(this.active?.def.id==='mirror_invasion'&&enemy&&!enemy.boss&&!enemy.eventMeteor){enemy.eventMirror=true;enemy.mirrorSpawn=true;enemy.hp=Math.max(1,Math.round(enemy.hp*.88));enemy.max=enemy.hp}return enemy}
