...
class BattleEventSystem{
 ...
 canStart(def=null){const bossIn=Math.max(0,(build?.nextBossAt??Infinity)-elapsed),requiredGap=(def?.duration||0)+10;return running&&!paused&&!dying&&state==='game'&&!enemies.some(e=>e.boss)&&!awakeningSystem.pending&&!this.active&&!this.warning&&bossIn>requiredGap}
