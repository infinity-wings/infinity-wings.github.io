 ...
 for(const b of bullets){
  if(b.laser)drawPlayerLaserBeam(b,lowFx)
   ...
   if(b.awakening==='main_piercer'){
    ...
    ctx.save();ctx.translate(b.x,b.y);ctx.scale(1.3,1.3);ctx.globalCompositeOperation='lighter';ctx.lineCap='round';
