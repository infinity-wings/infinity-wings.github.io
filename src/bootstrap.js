...
const UI={
 boot:$('#bootScreen'),menu:$('#menuScreen'),saveSelect:$('#saveSelectScreen'),story:$('#storyScreen'),core:$('#coreScreen'),hangar:$('#hangarScreen'),fighterSelect:$('#fighterSelectScreen'),archive:$('#archiveScreen'),settings:$('#settingsScreen'),death:$('#deathScreen'),pause:$('#pauseScreen'),chapterComplete:$('#chapterCompleteScreen'),migration:$('#migrationScreen'),
...
const keys={};
let state='boot',running=false,paused=false,last=0,elapsed=0,spawnCd=0,bossSpawned=false,shake=0,damageShake=0,joyX=0,joyY=0;
let runGeneration=0;
