...
for(const image of [shipSpriteAssets.player,shipSpriteAssets.drone,shipSpriteAssets.guard,shipSpriteAssets.boss,...Object.values(shipSpriteAssets.enemies),...Object.values(shieldSpriteAssets),deepSpaceBackgroundAsset,...Object.values(spaceLandmarkAssets)])image.decoding='async';
...
function drawTexturedEnemyOnly(e,pulse,hpRatio){
 ...
 const styledImage=e.boss?getTintedShipSprite(image,bossProfile.tint,e.awakenedBoss?.27:.17):e.eventMirror?getTintedShipSprite(image,'#645cff',.42):image;
